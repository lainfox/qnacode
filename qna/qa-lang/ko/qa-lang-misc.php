...
*/
	...
	return array(
		...
		'captcha_confirm_fix' => '^5이메일 인증^6을 하면 이 인증단어 입력창이 사라집니다.',
		'captcha_error' => '안티스팸 - 인증단어 입력창의 단어를 정확히 입력해 주세요.',
		'captcha_label' => '안티스팸 - 인증단어 입력:',
		'captcha_login_fix' => '^1로그인^2 또는 ^3회원가입^4을 하면 인증단어 입력창이 사라집니다.',
